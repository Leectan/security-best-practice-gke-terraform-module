...
resource "google_project_iam_member" "storage-object-view" {
  project = google_project_iam_member.service_account-resource-metadata-writer.project
  role = "roles/storage.objectViewer"
  member = "serviceAccount:${google_service_account.service_account.email}"
}

output "google-service-account" {
